...
#                 width
        ...
        if attach_dir == '-y':
            if endstop_side == 1:
                ...
                endstop_posx = (p1x - extra_w - endstopbox_l )
            ...
            if endstop_side != 0:
                ...
                endstopbolt0_pos = FreeCAD.Vector(
                                  endstop_posx + TOL + endstop_bolt2lend,
            ...
            h_nuthole = fcfun.NutHole (nut_r = pulleynut_d/2. + 1.5*TOL,
